...
class TestTransactionGet(APITestCase):
    ...
    def setUp(self) -> None:
        ...
        self.transaction1 = Transaction.objects.create(transaction_type='DE',
                                                       date="2022-02-01",
                                                       amount=10,
                                                       debit_account=None,
                                                       credit_account=self.account)

        self.transaction2 = Transaction.objects.create(transaction_type='SQ',
                                                       date="2022-02-02",
                                                       amount=5,
    ...
    def test_transaction_get_results_count(self):
        ...
        transaction_get = self.client.get(
            '/transaction/', format='json').data.items()
        get_dict = {}
    ...
    def test_transaction_get_amount(self):
        ...
        # Then
        self.assertEqual(transaction1_get.amount,
                         self.transaction1.amount)
        self.assertEqual(transaction2_get.amount,
                         self.transaction2.amount)
