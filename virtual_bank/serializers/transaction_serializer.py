    ...
    def validate(self, data):
        ...
        if self.context['request'].method == "POST":
            ...
            if data['debit_account'] != None:
                ...
                if not transaction_date_most_recent_than_account_opening_date(data['date'], debit_account_opening_date):
                    raise serializers.ValidationError(
            ...
            if data['credit_account'] != None:
                ...
                if not transaction_date_most_recent_than_account_opening_date(data['date'], credit_account_opening_date):
                    raise serializers.ValidationError(
