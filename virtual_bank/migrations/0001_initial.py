    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('opening_date', models.DateField(default=datetime.datetime(2022, 7, 10, 15, 27, 35, 348991, tzinfo=utc), verbose_name='Data de abertura')),
        ...
        migrations.CreateModel(
            name='Balance',
            fields=[
                ('account_number', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, primary_key=True, serialize=False, to='virtual_bank.account')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date', models.DateField(default=datetime.datetime(2022, 7, 10, 15, 27, 35, 350985, tzinfo=utc), verbose_name='Data')),
