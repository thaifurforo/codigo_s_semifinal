    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('account_number', models.CharField(editable=False, max_length=8, null=True, unique=True, verbose_name='Número da conta')),
                ('active_account', models.BooleanField(default=True, verbose_name='Conta ativa')),
                ('opening_date', models.DateField(default=datetime.datetime(2022, 7, 19, 1, 20, 19, 849792, tzinfo=utc), verbose_name='Data de abertura')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(default='', max_length=80, validators=[django.core.validators.MinLengthValidator(5)], verbose_name='Nome completo ou Razão social')),
                ('phone_number', models.CharField(default='', help_text='Formato: +DI DD 00000-0000', max_length=17, validators=[django.core.validators.RegexValidator('\\+[0-9]{2} [0-9]{2} (?:[2-8]|9[1-9])[0-9]{3}-[0-9]{4}', message='Telefone em formato inválido')], verbose_name='Telefone')),
                ...
                ('door_number', models.CharField(default='', max_length=10, validators=[django.core.validators.MinLengthValidator(1)], verbose_name='Número (endereço)')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date', models.DateField(default=datetime.datetime(2022, 7, 19, 1, 20, 19, 852783, tzinfo=utc), verbose_name='Data')),
        ...
        migrations.AddField(
            model_name='account',
            name='customer',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='virtual_bank.customer', verbose_name='Cliente'),
        ),
    ]
