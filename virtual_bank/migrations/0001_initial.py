    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('account_number_no_cd', models.CharField(default='', editable=False, max_length=8, unique=True, verbose_name='Número da conta sem dígito verificador')),
                ('check_digit', models.CharField(default='', editable=False, max_length=1, verbose_name='Dígito verificador do número conta')),
                ('active_account', models.BooleanField(default=True, verbose_name='Conta ativa')),
                ('opening_date', models.DateField(default=datetime.datetime(2022, 7, 13, 2, 30, 3, 94265, tzinfo=utc), verbose_name='Data de abertura')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date', models.DateField(default=datetime.datetime(2022, 7, 13, 2, 30, 3, 96260, tzinfo=utc), verbose_name='Data')),
