...
class Account(models.Model):
    ...
    account_number = models.CharField(verbose_name='Número da conta',
                                      max_length=8, default='', editable=False, unique=True)
    account_number_no_cd = models.CharField(
        unique=True, verbose_name='Número da conta sem dígito verificador', max_length=8, default='', editable=False)
    check_digit = models.CharField(
        verbose_name='Dígito verificador do número conta', default='', editable=False, max_length=1)
