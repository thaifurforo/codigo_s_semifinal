"""Module with the validators for the opening_date field from the Account serializer.
"""
...
def change_opening_date(update_opening_date, current_opening_date):
    ...
    Args:
        update_opening_date (date): The opening_date field set in the update request (PUT or PATCH)
        current_opening_date (date): The opening_date field saved in the object instance
